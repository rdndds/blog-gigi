      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-12">
          {data.hobbies.map((hobby: any, index: number) => {
            ...
            return (
              <Card key={hobby.title} className="group border-0 shadow-soft hover:shadow-large transition-all duration-300">
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    <div className="p-3 rounded-lg group-hover:scale-110 transition-transform" style={{ background: `linear-gradient(to bottom right, ${colorMap[hobby.color as keyof typeof colorMap]})` }}>
